  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#f4f5fb] dark:bg-dark-bg-primary'>
      <div className='fixed inset-0'>
        ...
        <div className='absolute left-0 top-0 block h-[400px] w-[400px] rounded-full bg-[#4338ca] opacity-[0.15] mix-blend-multiply blur-[128px] sm:opacity-[0.55] dark:hidden dark:opacity-35' />
        <div className='absolute bottom-0 right-0 block h-[400px] w-[400px] rounded-full bg-[#8b5cf6] opacity-[0.10] mix-blend-multiply blur-[128px] sm:opacity-[0.60] dark:hidden dark:opacity-25' />
        <div className='absolute right-1/4 top-1/2 block h-[500px] w-[450px] rounded-full bg-[#665cf6] opacity-[0] mix-blend-multiply blur-[128px] sm:opacity-[0.65] dark:hidden dark:opacity-35' />
